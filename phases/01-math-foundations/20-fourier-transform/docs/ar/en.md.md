...
3. Combine the two half-size DFTs using "twiddle factors" e^(-2_pi_i\*k/N).
...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Linearity                                          | a_x + b_y                                                                                        | a_X + b_Y                                                                                                                                      |
| Time shift                                         | x[n - k]                                     | X[f] \* e^(-2_pi_i_f_k/N)                                               |
| Frequency shift                                    | x[n] \* e^(2_pi_i_f0_n/N) | X[f - f0]                                                                                  |
...
| Twiddle factor                                      | The complex exponential e^(-2_pi_i\*k/N) used to combine sub-DFTs in the FFT butterfly computation                                                                                                                     |
