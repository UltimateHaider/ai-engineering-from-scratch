...
You know vectors and dot products. You know that a matrix transforms inputs into outputs. But how does a machine _learn_ which transformation to use?
...
2. Modify the Perceptron class to track the decision boundary (w1_x1 + w2_x2 + b = 0) at each epoch. Print how the line shifts during training on the AND gate.
