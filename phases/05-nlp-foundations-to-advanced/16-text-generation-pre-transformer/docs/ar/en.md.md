...
6. **Kneser-Ney.** Absolute discounting plus a clever choice for the lower-order model: use _continuation probability_ (how many contexts a word appears in) instead of raw frequency.
