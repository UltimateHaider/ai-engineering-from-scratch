...
A user says a passphrase. You want to know: is this the person they claim to be (_verification_, 1:1), or is it the first person in your enrollment bank (_identification_, 1:N)? Or neither — is this an unknown speaker (_open-set_)?
