...
- **bf16 decoder, fp32 numerics for the final resize.** The SD 1.x VAE was released in fp32 and _silently produces NaNs_ when cast to fp16 at 1024²+. SDXL ships `madebyollin/sdxl-vae-fp16-fix` — always prefer the fp16-fix variant or use bf16.
