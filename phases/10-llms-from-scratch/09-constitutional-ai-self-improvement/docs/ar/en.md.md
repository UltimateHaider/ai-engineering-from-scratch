...
The constitution moves the alignment contract from _data_ to _text_. Changing behavior under RLHF means re-labeling thousands of pairs. Changing behavior under CAI means editing a paragraph. This is the main practical win.
