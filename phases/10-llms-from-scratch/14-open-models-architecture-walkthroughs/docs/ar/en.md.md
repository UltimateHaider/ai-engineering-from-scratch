...
The original transformer applied layer norm after each sublayer. Every open model since GPT-2 puts it _before_ each sublayer. Pre-norm is strictly easier to train at depth. Nothing to argue about.
