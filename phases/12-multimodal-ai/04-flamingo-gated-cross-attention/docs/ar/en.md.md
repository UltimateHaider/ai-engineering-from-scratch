...
4. Why does Flamingo's cross-attention mask let a text token attend to _only the most recent_ preceding image rather than all preceding images? Read the Flamingo paper Section 2.4 and explain the tradeoff.
