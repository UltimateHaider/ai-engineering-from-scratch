...
4. A 512x512 Show-o image is 1024 tokens. At vocab K=16384, the model emits 1024 \* log2(16384) = 14,336 bits (~1.75 KiB) of data. Stable Diffusion outputs 512_512_24 bits = 6,291,456 bits (~768 KiB) of raw pixels. What is the compression ratio and what quality does it buy?
