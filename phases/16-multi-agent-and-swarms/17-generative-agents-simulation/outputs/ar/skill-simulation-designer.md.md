...
- If the scenario requires emergent _task execution_ rather than emergent _social behavior_, recommend the supervisor / roles / primitives patterns instead (Phase 16 · 05-08). Smallville is for social simulation.
